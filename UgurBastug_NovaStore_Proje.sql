...
-- Not: Bu proje T-SQL değil, PostgreSQL ile geliştirilmiştir.
-- SERIAL, GENERATED ALWAYS AS IDENTITY ve pg_dump gibi
-- PostgreSQL'e özgü sözdizimi kasıtlı olarak kullanılmıştır.
...
-- Sorgu 1: Sürekli uzun JOIN sorguları yazmamak için; Müşteri Adı, Sipariş Tarihi, Ürün Adı ve Adet bilgilerini tek bir tablodaymış gibi getiren vw_OrderSummary isminde bir VIEW oluşturun
